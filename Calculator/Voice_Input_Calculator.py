...
root.config(bg='#242124')
root.geometry('665x480+100+100')
...
logoLabel = Label(root, image=logoImage, bg='#242124')
...
for i in button_text_list:
    if (i=='AC'):
         button = Button(root, width=5, height=2, bd=1, relief=SUNKEN, text=i, bg='#059033', fg='#fff',
                        font=('arial', 18, 'bold'), activebackground='White', command=lambda button=i: click(button))  
    elif(i=='='):
        button = Button(root, width=5, height=2, bd=1, relief=SUNKEN, text=i, bg='#fe9037', fg='#fff',
                        font=('arial', 18, 'bold'), activebackground='White', command=lambda button=i: click(button))
             
    else:
        button = Button(root, width=5, height=2, bd=1, relief=SUNKEN, text=i, bg='#154360', fg='#fff',
                        font=('arial', 18, 'bold'), activebackground='White', command=lambda button=i: click(button))
